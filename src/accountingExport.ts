...
export function renderAccountingHtml(report: AccountingReport, company: CompanySettings) {
  ...
  <h2>Synthèse mensuelle</h2><table><thead><tr><th>Mois</th><th class="num">CA HT</th><th class="num">Achats directs</th><th class="num">Charges</th><th class="num">Marge</th><th class="num">Avant IS</th><th class="num">IS estimé</th><th class="num">Après IS</th><th class="num">Taux de marge</th></tr></thead><tbody>${monthlyRows || '<tr><td colspan="9">Aucune écriture sur la période.</td></tr>'}</tbody></table>
